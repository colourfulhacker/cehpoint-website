import {
    ...
    SiMlflow, SiKubeflow, SiAwslambda, SiDatabricks,
    SiPrometheus, SiGrafana, SiDatadog,
    SiBurpsuite, SiOwasp, SiKalilinux, SiWireshark,
    SiSplunk, SiElastic, SiCrowdstrike, SiPaloaltonetworks,
    SiMicrosoftdefender, SiFortinet, SiCisco,
    ...
    SiPlaid, SiGoogleanalytics, SiMixpanel, SiSegment, SiHotjar,
...
export const TechnologyIcons: Record<string, React.ElementType> = {
    ...
    "ELK Stack": SiElastic,
    "CrowdStrike Falcon": SiCrowdstrike,
    "Palo Alto Cortex XDR": SiPaloaltonetworks,
    "Microsoft Defender": SiMicrosoftdefender,
